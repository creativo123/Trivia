...
public class Validation {
    ...
    // This code is from my github repository - https://github.com/creativo123
    // This class validates the input elements like textbox, radio button or checkboxes for them to contain validate inputs
    ...
    public static boolean validate(RadioGroup radioGroup, boolean prompt) {

        if (radioGroup.getCheckedRadioButtonId() == -1) {
            if (prompt)
                Snackbar.make(radioGroup, "Please select one option", Snackbar.LENGTH_LONG).show();
            return false;
        }
    ...
    public static boolean validate(RadioGroup radioGroup, boolean prompt, boolean containsCheckbox) {
        ...
        if (!selected) {
            if (prompt)
                Snackbar.make(radioGroup, "Please select atleast one option", Snackbar.LENGTH_LONG).show();
            return false;
        }
